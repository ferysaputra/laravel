...
<title>LAZIS</title>
<link rel="icon" href="{{url('public/img/logo2.png')}}" type="image/png">
...
<header id="header_wrapper">
  <div class="container">
    <div class="header_box">
      <div class="logo"><a href="#"><img src="{{url('public/img/logo2.png')}}" alt="logo"></a></div>
      ...
      <div class="navbar-header">
	    ...
	    <div id="main-nav" class="collapse navbar-collapse navStyle">
			<ul class="nav navbar-nav" id="mainNav">
			  ...
			  <li><a href="#aboutUs" class="scroll-link">introduction</a></li>
			  ...
			  <li><a href="#team" class="scroll-link">Tentang kami</a></li>
			  <li><a href="#contact" class="scroll-link">donasi</a></li>
			</ul>
      </div>
	 </nav>
    </div>
        ...
        <div class="row">
          <div class="col-lg-5 col-sm-7">
            <div class="top_left_cont zoomIn wow animated"> 
              <h2>MEMBAHAGIAKAN <strong> YATIM </strong> DI MOMENT KARIM</h2>
              <p>Dalam satu tahun kalender Hijrlyah, ada empat bulan yang Allah jadikan istimewa. Mubarram salah satunya.</p>
              <a href="#service" class="read_more2">DONASI SEKARANG</a> </div>
          </div>
          <div class="col-lg-7 col-sm-4">
			<img src="{{url('public/img/main.png')}}" class="zoomIn wow animated" alt="" />
		  </div>
        </div>
      </div>
    </div>
...
<div class="inner_wrapper">
  <div class="container">
	...
	<div class="row">
      <div class=" col-lg-4 col-md-4 col-sm-4 col-xs-12 pull-right"><img src="{{url('public/img/about-img.jpg')}}" class="img-circle delay-03s animated wow zoomIn" alt=""></div>
      	<div class=" col-lg-7 col-md-7 col-sm-7 col-xs-12 pull-left">
        	<div class=" delay-01s animated fadeInDown wow animated">
			<h3>Pengertian dan Macam-Macam Zakat.</h3><br/> 
            <p>Zakat adalah sejumlah harta yang wajib dikeluarkan oleh umat Muslim untuk diberikan kepada golongan yang berhak menerima, seperti fakir miskin dan semacamnya, sesuai dengan yang ditetapkan oleh syariah. Zakat termasuk rukun Islam ke-4 dan menjadi salah satu unsur paling penting dalam menegakkan syariat Islam. .</p> <br/>
<p>Oleh karena itu, hukum zakat adalah wajib bagi setiap Muslim yang telah memenuhi syarat-syarat tertentu. Zakat juga merupakan bentuk ibadah seperti shalat, puasa, dan lainnya dan telah diatur dengan rinci berdasarkan Al-Quran dan Sunnah.</p>
</div>
<div class="work_bottom"> <span>Ingin tahu Lebih?</span> <a href="#contact" class="contact_btn">Read More</a> </div>       
	   </div>
      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="service_block">
            ...
            <h3 class="animated fadeInUp wow">BUS</h3>
        ...
        <div class="col-lg-4 borderLeft">			
          <div class="service_block">
            ...
            <h3 class="animated fadeInUp wow">ASYIQ</h3>
            <p class="animated fadeInDown wow">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text.</p>
          </div>
        </div>
        <div class="col-lg-4 borderLeft">
          <div class="service_block">
            ...
            <h3 class="animated fadeInUp wow">RBA</h3>
            <p class="animated fadeInDown wow">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text.</p>
          </div>
        </div>
      </div>
	   <div class="row borderTop">
        <div class="col-lg-4 mrgTop">
          <div class="service_block">
            ...
            <h3 class="animated fadeInUp wow">KUBAH</h3>
            <p class="animated fadeInDown wow">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text.</p>
          </div>
        </div>
        <div class="col-lg-4 borderLeft mrgTop">
          <div class="service_block">
            ...
            <h3 class="animated fadeInUp wow">AL-MISBAH</h3>
            <p class="animated fadeInDown wow">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text.</p>
          </div>
        </div>
        <div class="col-lg-4 borderLeft mrgTop">
          <div class="service_block">
            ...
            <h3 class="animated fadeInUp wow">SIMBAHKU</h3>
            <p class="animated fadeInDown wow">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text.</p>
          </div>
        </div>
      </div>
  ...
  <div class="portfolio"> 
    ...
    <div class="isotope fadeInLeft animated wow" style="position: relative; overflow: hidden; height: 480px;" id="portfolio_wrapper"> 
      ...
      <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four   appleIOS isotope-item">
        <div class="portfolio_img"> <img src="{{url('public/img/portfolio_pic1.jpg')}}"  alt="Portfolio 1"> </div>        
      ...
      <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(337px, 0px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four  design isotope-item">
        <div class="portfolio_img"> <img src="{{url('public/img/portfolio_pic2.jpg')}}" alt="Portfolio 1"> </div>
        <div class="item_overlay">
          <div class="item_info"> 
      ...
      <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(674px, 0px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four  design  isotope-item">
        <div class="portfolio_img"> <img src="{{url('public/img/portfolio_pic3.jpg')}}" alt="Portfolio 1"> </div>
        <div class="item_overlay">
          <div class="item_info"> 
      ...
      <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(1011px, 0px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four  android  prototype web isotope-item">
        <div class="portfolio_img"> <img src="{{url('public/img/portfolio_pic4.jpg')}}" alt="Portfolio 1"> </div>
        <div class="item_overlay">
          <div class="item_info"> 
      ...
      <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(0px, 240px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four  design isotope-item">
        <div class="portfolio_img"> <img src="{{url('public/img/portfolio_pic5.jpg')}}" alt="Portfolio 1"> </div>
        <div class="item_overlay">
          <div class="item_info"> 
      ...
      <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(337px, 240px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four  web isotope-item">
        <div class="portfolio_img"> <img src="{{url('public/img/portfolio_pic6.jpg')}}" alt="Portfolio 1"> </div>
        <div class="item_overlay">
          <div class="item_info"> 
      ...
      <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(674px, 240px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four  design web isotope-item">
        <div class="portfolio_img"> <img src="{{url('public/img/portfolio_pic7.jpg')}}" alt="Portfolio 1"> </div>       
        <div class="item_overlay">
          <div class="item_info"> 
      ...
      <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(1011px, 240px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four   android isotope-item">
        <div class="portfolio_img"> <img src="{{url('public/img/portfolio_pic8.jpg')}}" alt="Portfolio 1"> </div>       
        <div class="item_overlay">
          <div class="item_info"> 
...
<div class="client_logos"><!--client_logos-->
  <div class="container">
    <ul class="fadeInRight animated wow">
      <li><a href="javascript:void(0)"><img src="{{url('public/img/client_logo.png')}}" alt=""></a></li>
      <li><a href="javascript:void(0)"><img src="{{url('public/img/client_logo.png')}}" alt=""></a></li>
      <li><a href="javascript:void(0)"><img src="{{url('public/img/client_logo.png')}}" alt=""></a></li>
      <li><a href="javascript:void(0)"><img src="{{url('public/img/client_logo.png')}}" alt=""></a></li>
    </ul>
...
<footer class="footer_wrapper" id="contact">
  ...
  <div class="container">
    <div class="footer_bottom"><span>Copyright © 2020,<a href="http://ferysaputra.net">Fery Saputra</a>. </span> </div>
  </div>
</footer>
